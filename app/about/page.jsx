...
const AboutPage = () => {
  return (
    <div className='min-h-screen flex flex-col gap-6 justify-center items-center'>
      <Image src={Logo} alt='profile-pic' height={200} width={200} className='rounded-full w-18 h-18 sm:w-24 sm:h-24 border hover:border-green-600 hover:-translate-y-10 transition-all duration-500 ease-linear shadow-lg' priority/>
